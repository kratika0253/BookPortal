...
session_start();
	...
	if(isset($_GET['search']))
		$sql = "SELECT * FROM books where bookname like '%".$_GET['search']."%'";
	else
	...
	<div id="page">
			                ...
			                <div class="col-md-3">
			                  <script type="text/javascript">
			                  	function searchBooks(){
			                  		window.location.href = "courses.php?search=" + document.getElementById("search").value;
			                  	}
			              		</script>
			                  <input type="button" name="submit" id="submit" value="Search book" class="btn btn-primary btn-block clsSearch" onclick="searchBooks()"/>
			                </div>
			              </div>
			            </form>
			        <?php } ?>
			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-md-12 colorlib-heading center-heading text-center animate-box">
						<h1 class="heading-big">Overview</h1>
						<h2>Overview</h2>
					</div>
				</div>
		...
		<div class="colorlib-classes">
			<div class="container">
				<div class="row">
					<div class="col-md-12 colorlib-heading center-heading text-center animate-box">
						<h1 class="heading-big">Editor's picks</h1>
